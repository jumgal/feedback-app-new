...
const ZeroFeedback = () => {
  return (
    <div className="d-flex flex-column align-items-center mt-5 justify-content-center align-content-center">
      ...
      <h2 className="text-color-dark-second mt-5 mb-4">
        There is no feedback yet!
      </h2>
      <p className="mb-0 text-color-dark-second">
        Got a suggestion? Found a bug that needs to be squashed?
      </p>
      <p className="text-color-dark-second mb-4">
        We love hearing about new ideas to improve our app
      </p>
      <Link to="/new-feedback">
        <button className="btn btn-color-purple px-3 py-3">
